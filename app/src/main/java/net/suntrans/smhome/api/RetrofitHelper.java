...
import net.suntrans.smhome.App;
import net.suntrans.smhome.converter.MyGsonConverterFactory;
...
public class RetrofitHelper {
    public static final String BASE_URL = "http://smartapp.suntrans-cloud.com/";
